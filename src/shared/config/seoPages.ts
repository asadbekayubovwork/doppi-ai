...
export const SEO_PAGES: readonly SeoPage[] = [
  ...
  { path: SERVICE_PATHS.rag, seoKey: "ragAgent", service: "rag", priority: 0.9 },
  { path: SERVICE_PATHS.voice, seoKey: "voiceAgent", service: "voice", priority: 0.9 },
  { path: SERVICE_PATHS.video, seoKey: "videoGenerator", service: "video", priority: 0.9 },
