 ...
 * the same people and the build can publish them as structured data; the role
 * and bio come from i18n under `team.roles.<id>` / `team.bios.<id>`. Kept free
 * of Vue and `@/` imports so the build (build/seo.ts) can read it as well.
 */
export const TEAM_MEMBERS: TeamMember[] = [
  ...
  },
  {
    ...
    socials: [
      {
        icon: "linkedin",
        href: "https://www.linkedin.com/in/abdumalikov/",
        label: "LinkedIn",
      },
