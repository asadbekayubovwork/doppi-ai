...
describe("PIndex (landing page)", () => {
  it("mounts every section without errors", () => {
    ...
    for (const id of ["top", "problem", "solution", "features", "how", "voice", "results", "pricing", "faq", "about", "team", "contact"]) {
  ...
  it("renders hero, trust bar and voice transcript copy", () => {
    ...
    expect(text).toContain("O'zbekiston uchun AI Marketing tizimi")
